...
def page_tech(c):
    ...
    TECH_DESC = {
        "nano resonance":       ("Nano Resonance", "By engineering an intentionally heavy cone mass, Nano Resonance forces the system natural resonant frequency (Fs) well below the target passband. This counters Hoffman Iron Law -- the trade-off between bass extension, enclosure size, and efficiency -- allowing genuine low-frequency extension from an enclosure only 12-23mm deep."),
        ...
        "aeroframe chassis":    ("AeroFrame Chassis", "6061 aerospace-grade aluminium is machined to form the speaker structural chassis. Beyond providing rigidity under excursion, the chassis acts as a passive heatsink -- drawing heat away from the voice coil through direct thermal coupling to the body."),
