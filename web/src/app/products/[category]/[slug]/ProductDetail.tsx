  ...
  return (
    <div className="pd-page">
      ...
      {(product.productVideos && product.productVideos.length > 0 && !isAmp) ? (
        ...
        />
      ) : ['prod-cedar', 'prod-ghost2', 'prod-bonsai-ic', 'prod-cane-ic', 'prod-oak', 'prod-willow', 'prod-sage', 'prod-bergenia'].includes(product._id) && (product.lifestyleImages?.length ?? 0) > 0 ? (
        <section className="vg-section">
          <div className="vg-videos">
            <div className="vg-panel">
              {(() => {
